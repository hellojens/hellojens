...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('jquery', get_template_directory_uri() . '/js/vendor/jquery.js', array(), '1.0.0' , true); // Jquery
        ...
        wp_register_script('fitVids', get_template_directory_uri() . '/js/fitvids.js', array('jquery'), '1.0.0' , true); // Custom scripts
...
function html5blank_styles()
{
    ...
    wp_register_style('foundationstyle', get_template_directory_uri() . '/css/foundation.css', array(), '1.0', 'all');
    wp_enqueue_style('foundationstyle'); // Enqueue it!
...
function register_html5_menu()
{
    register_nav_menus(array( // Using array to specify more menus if needed
        ...
        'category-menu' => __('Category Menu', 'html5blank'), // Sidebar Navigation
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        ...
        'description' => __('Footer links', 'html5blank'),
        'id' => 'footer-area',
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
...
remove_filter('term_description','wpautop'); // Remove p tag from descriptions 
